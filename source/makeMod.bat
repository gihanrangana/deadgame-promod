...
cd ..\..\ 
START cod4x18_dedrun.exe +set dedicated 2 +set fs_game mods/%modname% +set net_port 28960 +exec server.cfg +set sv_cheats 0 +set developer 0 +set r_xassetnum "xmodel=1200"﻿ +map_rotate
TIMEOUT /T 2 > NUL
