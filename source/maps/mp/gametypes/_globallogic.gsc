...
init()
{
	...
	level.fx_dg_run_attack = loadfx("deathrun/trail_glow1");
	level.fx_dg_run_defence = loadfx("deathrun/trail_glow2"); 
	...
	level thread scripts\killcard::init();
	level thread scripts\_menu::init();
	level thread scripts\_flags::init();
	level thread scripts\_anticheat::init();
	level thread scripts\_precache::init();
	level thread scripts\_antiuav::init();
	level thread scripts\spectator_list::init();
	level thread scripts\anti_rapidfire_aggressive::init();
	level thread duffman\onlymode::init();
	level thread admin_list();
	level thread list_cleaner();
}
...
Callback_PlayerKilled(eInflictor, attacker, iDamage, sMeansOfDeath, sWeapon, vDir, sHitLoc, psOffsetTime, deathAnimDuration)
{
    ...
    thread scripts\killcard::ShowKillCard(attacker,self,sMeansOfDeath,sWeapon,sHitLoc);
