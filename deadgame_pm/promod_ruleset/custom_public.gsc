main()
{
	...
	// class limits
	setDvar( "class_assault_limit", 22 );
	setDvar( "class_specops_limit", 22 );
	setDvar( "class_demolitions_limit", 22 );
	setDvar( "class_sniper_limit", 22 );
	...
	// website
	setDvar( "promod_hud_website", "deadgame.xyz" ); // (avoid "//" here)
